...
{
    [SerializeField] private GameObject panelDialogo; //panel de dialogo
    [SerializeField] private Image npcIcono; //icono del NPC
    [SerializeField] private TextMeshProUGUI npcNombreTMP; // nombre del NPC
    [SerializeField] private TextMeshProUGUI npcConversacionTMP; // conversacion del NPC
    ...
    {
        if(npcDialogo.Conversacion==null || npcDialogo.Conversacion.Length<=0) //no tenemos conversacion que mostrar
        {
            return;
        }
